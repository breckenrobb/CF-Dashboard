...
############################################# Plotting ###########################################################
PlotTheme = theme(axis.text=element_text(size=18),    #Text size for axis tick mark labels
                  axis.title.x=element_text(size=22, hjust=0.5, margin=margin(t=20, r=20, b=20, l=20)),               #Text size and alignment for x-axis label
                  axis.title.y=element_text(size=22, vjust=0.5,  margin=margin(t=20, r=20, b=20, l=20)),              #Text size and alignment for y-axis label
                  plot.title=element_blank(),      #No title
                  legend.title=element_text(size=22),                                                                    #Text size of legend category labels
                  legend.text=element_text(size=18), #Text size of legend title
...
ggsave(paste(PARK,"-Deficit.png",sep=""), path = './figures/summary-plots', height=PlotHeight, width=PlotWidth, bg="white")
